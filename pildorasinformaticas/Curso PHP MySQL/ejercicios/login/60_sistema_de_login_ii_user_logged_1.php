...
<head>
    <meta charset="utf-8" />
    <title>60 - Sistema de login II (user logged 1)</title>
</head>

<body>
    <h1>60 - Sistema de login II (user logged 1)</h1>
    
    <?php
    echo "<br>Hola " . $_SESSION["usuarioLogeado"];
    ?>

    <p>Esto es información sólo para usuarios registrados</p>
    <br><a href="61_sistema_de_login_ii_user_logged_2.php">Página 2</a>
    <br><a href="61_sistema_de_login_ii_user_logged_3.php">Página 3</a>

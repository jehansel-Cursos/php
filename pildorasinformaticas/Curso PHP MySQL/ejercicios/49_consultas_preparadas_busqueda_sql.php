...
$pais = mysqli_real_escape_string($conexion, $_POST["buscar"]);
...
$sql = "SELECT * FROM articulos WHERE paisorigen = ?";
echo "<br>" . $sql;
...
$ok = mysqli_stmt_bind_param($stmt, "s", $pais);
...
if ($ok == false) {
    ...
    echo "<br>Artículos encontrados:<br>";
